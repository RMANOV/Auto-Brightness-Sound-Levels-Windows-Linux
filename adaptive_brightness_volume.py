    ...
    def set_brightness(self, brightness: float) -> None:
        ...
        if self.brightness_method == "brightnessctl":
            ...
            if not success:
                ...
                print(f"{os.environ.get('USER', 'username')} ALL=(ALL) NOPASSWD: /usr/bin/brightnessctl")
                print(f"{os.environ.get('USER', 'username')} ALL=(ALL) NOPASSWD: /usr/bin/tee /sys/class/backlight/*/brightness")
                print("EOF")
                print()
